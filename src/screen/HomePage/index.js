export const HomePage = () => {
  let html = `    <nav class="w-full flex justify-between items-center">
    <div class="hidden md:flex justify-center items-center gap-1">
      ...
      <p class="text-gray-500 text-lg dark:text-colorText">Tehran,Iran</p>
    </div>
    <div
      class="w-1/2 bg-gray-100 dark:bg-secondary rounded-full h-[40px] flex items-center px-1"
    >
      <svg
        width="25"
        height="25"
  ...
  <main class="w-full mt-2">
    <section>
      <div class="w-full flex items-start justify-center flex-col md:hidden">
        <h1 class="dark:text-white text-xl">Tehran</h1>
        <p class="text-xs">12 September,Sunday</p>
      </div>
      <div class="w-full flex">
        ...
        <div class="w-1/2 flex justify-center items-center">
          <img src="./src/assets/imgs/cloud-pngrepo-com 1.png" alt="" />
        </div>
      </div>
    </section>
    <section
      class="w-full mt-2 rounded-[30px] bg-gray-100 dark:bg-secondary h-[120px] flex"
    >
      <div class="w-1/3 h-full flex flex-col justify-center items-center">
        <img src="./src/assets/imgs/wind-pngrepo-com 1.png" />
        <p class="text-gray-700 dark:text-white">10 m/s</p>
    ...
    <section class="flex flex-col gap-4">
      <div class="mt-8">
        <div>
          ...
          <div class="w-full overflow-x-auto flex justify-around gap-2 mt-1">
            <div
              class="min-w-[110px] w-[12%] h-28 rounded-lg dark:bg-secondary bg-gray-100 flex flex-col justify-around items-center"
            >
              <h4>10 am</h4>
              <img src="./src/assets/imgs/sun-pngrepo-com 2.png" alt="" />
              <p>16°</p>
            </div>
            <div
              class="min-w-[110px] w-[12%] h-28 rounded-lg dark:bg-secondary bg-gray-100 flex flex-col justify-around items-center"
      ...
      <div class="mt-8">
        <div>
          ...
          <div class="w-full overflow-x-auto flex gap-2 justify-around mt-1">
            <div
              class="min-w-[110px] w-[12%] h-28 rounded-lg dark:bg-secondary bg-gray-100 flex flex-col justify-around items-center"
            >
              <h4>10 am</h4>
